  ...
  return (
    <div className="container">
      ...
      <main className="main block">
        ...
        <code>$(touser) ► $(customapi.{origin}/api/tft/rank?channel=$(channel)&region=<span className="red">REGION</span>&player=<span className="red">PLAYERNAME</span>&tag=<span className="red">TAG</span>&type=text)</code>
        <br />
