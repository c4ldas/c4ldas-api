...
* 
* TO DO:  
* - Check how many people are using /api/valorant/schedule endpoint - Done!
* - If not many (or none at all), just put the /vlr.gg code directly on /api/valorant/schedule - Done!
* - Move the endpoint /api/valorant/schedule/vlr.gg to /api/valorant/schedule - Done!
* - Remove page.jsx from /(frontend)/valorant/schedule - Done!
* - Rename page_new.jsx to page.jsx from /(frontend)/valorant/schedule - Done!
*
* Pending:
* - Remove the page /valorant/schedule-vlrgg. At the moment it is set as deprecated.
* - Remove the route /api/valorant/schedule/vlr.gg. At the moment it is set as deprecated.
* - Remove the route /api/valorant/schedule/vlr
...
export async function GET(request) {
  try {
    ...
    if (!id) return NextResponse.json({ status: "failed", error: `Missing id. Check ${request.nextUrl.origin}/valorant/schedule for more information.` }, { status: 200 });
